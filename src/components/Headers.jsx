...
export default function Headers() {
  ...
  return (
    ...
    <header className='flex justify-between items-center px-3 max-w-6xl mx-auto' >
        <div>
        <img src="https://citypropertyintl.com/wp-content/uploads/2022/06/Untitled-1-1.png" alt="logo"  className='h-12 cursor-pointer'
    ...
    <div>
        ...
        <li className={`cursor-pointer py-3 text-sm font-semibold text-gray-400 border-b-[3px]  border-b-transparent ${pathMatchRoute("/sign-in") && "text-black  border-b-red-600" }`}   onClick={()=>navigate("/sign-in")} >Sign in</li>
